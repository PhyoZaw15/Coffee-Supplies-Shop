            ...
            <div class="col-sm-12">
              ...
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                  <a href="{{ route('admin-accounts.create') }}" class="btn btn-success btn-xs float-right"><i class="fa fa-plus"></i> Add New</a>
                </li>
              </ol>
            @endcan
            </div>
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                  <h3 class="card-title">Admin users are the following:</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <td>
                          @if(!empty($data->getRoleNames()))
                              @foreach($data->getRoleNames() as $role)
                                  <span class="badge badge-dark right">{{ $role }}</span>
                              @endforeach
                          @endif
                        </td>
                        <td>
